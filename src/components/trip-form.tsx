  ...
  return (
    ...
    >
      ...
      <FormSection
        ...
        lede={
          dense
            ? "ค้นหาผ่าน Google Maps/Places หรือพิมพ์รายละเอียดด้านล่าง"
            : "ค้นหาสถานที่ผ่าน Google Maps (Places API) หรือสำรอง OpenStreetMap — ตั้งจุดเช็คอินแล้วแก้ข้อความด้านล่างให้ชัด หรือพิมพ์เองทั้งหมดก็ได้"
        }
      >
        <TripMeetPointPicker
          fid={fid}
      ...
      <FormSection
        ...
        lede={
          dense
            ? "ไม่บังคับ — พิมพ์ชื่อสถานที่แล้วเลือกจากรายการ (Google Maps / Places)"
            : "ไม่บังคับ — พิมพ์ชื่อสถานที่แล้วเลือกจากรายการ ค้นหาผ่าน Google Maps (Places API) หรือสำรอง OpenStreetMap"
        }
      >
